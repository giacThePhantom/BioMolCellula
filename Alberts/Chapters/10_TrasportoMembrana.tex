...
\ce{Na+} che quando entra nella cellula \`e trasportato fuori da una pompa ad ATP per \ce{Na+-K+} che mantenendo il gradiente di \ce{Na+} guida il trasporto accoppiato. Tali 
...
fluido extracellulare in cui queste cellule si trovano fino al sangue. Symporter legati al \ce{Na+} si trovano nel dominio apicale delle cellule epiteliali e trasportano attivamente i 
...
\begin{itemize}
	...
	\item Pompe V-tipo: sono proteine simili a turbine con diverse subunit\`a, trasferiscono \ce{H+} in organelli come i lisosomi, vescicole sinaptiche e vacuoli acidificandone
		l'interno.
\end{itemize}
Molto imparentate con le pompe V-tipo sono le ATPasi F-tipo o ATP sintetasi in quanto usano il gradiente \ce{H+} per guidare la sintesi di ATP. Si trovano nella membrana plasmatica dei
...
Le cellule eucariotiche mantengono una concentrazione di \ce{Ca^{2+}} di $\sim 10^{-7}M$ nonostante una concentrazione extracellulare di $\sim 10^{-3}$, pertanto piccole variazioni 
...
\ce{Na+}. La \ce{Ca^{2+}} ATPasi nel reticolo sarcoplasmatico (SR), una membrana nelle cellule di muscolo scheletrico fa parte della prima categoria. L'SR \`e un tipo di reticolo
endoplasmatico che forma una rete di sacche tubulari che servono come magazzini di \ce{Ca^{2+}}. Quanto un azione potenzialmente depolarizzerebbe la membrana plasmatica della cellula
muscolare \ce{Ca^{2+}} viene rilasciato nel citosol dall'SR attraverso canali di rilascio che stimolano la contrazione del muscolo. La pompa \ce{Ca^{2+}} fa ritornare il \ce{Ca^{2+}} 
...
di amminoacidi protrudenti dalle eliche che formano siti di legami per il \ce{Ca^{2+}}. Nello stato non fosforilato sono accessibili unicamente dal lato citosilico e il legame di 
\ce{Ca^{2+}} causa una serie di cambi conformazionali che chiudono il passaggio e attivano una reazione di trasferimento del gruppo formato in cui viene trasferito in un apparato 
...
\subsection{La struttura dei canali batterici \ce{K+} mostra come un canale ionico lavora}
...
membrana plasmatica. Nelle cellule uno stimolo che causa depolarizzazione sufficiente apre i canali voltage-gated \ce{Na+} permettendo a una piccola quantit\`a dello ione di entrare
...
Ranvier, dove sono concentrati i canali \ce{Na+} in modo da permettere al potenziale di azione di propagarsi da nodo a nodo in conduzione saltatoria che permette un trasporto rapido
...
I canali di cationi voltage-gated possono essere a \ce{Na+} o a \ce{Ca^{2+}} per esempio. Si trova una grande diversit\`a tra le classi di questi canali, generati da geni multipli e 
...
\subsection{Diversi tipi di neuroni mostrano caratteristiche propriet\`a di stable firing}
...
raggruppati nelle membrana. L'influsso di \ce{Ca^{2+}} causa il rilascio nella fessura di neurotrasmettitori, conservati in vescicole sinaptiche e rilasciati attraverso esocitosi. I
...
un influsso di \ce{Na+} e di \ce{Ca^{2+}}, depolarizzando la membrana postsinaptica al di sotto del potenziale che genera un potenziale d'azione. Neurotrasmettitori inibitori aprono
canali \ce{Cl-} o \ce{K+} sopprimendo il firing rendendo pi\`u difficile la depolarizzazione. Molti neurotrasmettitori possono avere entrambi i ruoli in base a dove sono rilasciati, a
...
\ce{Na+}, \ce{K+} e \ce{Ca^{2+}} e si nota pertanto come il canale non sia selettivo e la contribuzione al flusso dipende dalla concentrazione dei cationi e dal loro gradiente. Essendo
...
Questa membrana \`e ricca di canali \ce{Na+} voltage-gated e contiene altre classi di canali ionici: tre selettivi per \ce{K+} e uno per \ce{Ca^{2+}}, rispettivamente canali 
...
negativo, cosa che non pu\`o avvenire fino a che persiste il segnale dai PSP in modo da permettere di ripristinare i canali \ce{Na+} dalla loro disattivazione. Questa funzione dei
canali \ce{K+} avviene in quanto la loro cinetica lenta  permette la loro apertura durante la fase di abbassamento del potenziale d'azione, quando i canali \ce{Na+} sono disattivati. 
La loro apertura permette un efflusso di \ce{K+} che porta la membrana verso l'equilibrio di potenziale \ce{K+}. La ripolarizzazione richiude i canali stessi. Il segmento iniziale \`e
pertanto resettato in modo che lo stimolo depolarizzante dagli input sinaptici pu\`o causare un altro potenziale d'azione. I canali di \ce{K+} rapidamente disattivanti regolano la
...
depolarizzazione. Il processo di codifica \`e modulato da altri due tipi di canali: canali di \ce{Ca^{2+}} voltage-gated e e attivati da \ce{K+} che agiscono insieme 
riducendo la risposta della cellula a uno stimolo prolungato e costante in un processo detto adattamento. I canali \ce{Ca^{2+}} attivati si aprono in risposta a un aumento di 
concentrazione di \ce{Ca^{2+}} alla parte citoplasmatica del canale. Uno stimolo depolarizzante forte e prolungato causa infatti un lungo treno di potenziali d'azione ognuno dei quali
...
di \ce{K+} rende pi\`u difficile la depolarizzazione della membrana aumentando il ritardo tra un potenziale d'azione e il successivo. Tale adattamento permette al neurone di reagire
...
altamente permeabili a \ce{Ca^{2+}} che agisce come segnale intracellulare nella cellula postinaptica, causando una cascata di cambiamenti responsabili per la LTP. Le sinapsi presentano

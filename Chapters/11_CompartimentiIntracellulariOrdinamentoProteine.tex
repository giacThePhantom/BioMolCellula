...
la maggior parte dei lipidi e conserva ioni \ce{Ca^{2+}}. Le regioni dell'ER senza ribosomi sono dette ER liscio. Molte delle proteine e dei lipidi vengono mandati dall'ER nell'apparato
...
\subsection{Trasporto nella membrana interna mitocondriale e nello spazio intermembrana avviene secondo diverse strade}
...
\section{Il reticolo endoplasmatico}
...
detossificare droghe liposolubili e altri composti creati dal metabolismo. Un altra funzione dell'ER \`e il sequestro di \ce{Ca^{2+}} dal citosol. Il rilascio e la ripresa avviene in
...
\subsection{Nelle proteine transmembrana a singolo passaggio una singola sequenza di segnale ER interna rimane nel bistrato lipidico come una $\mathbf{\alpha}$-elica che attraversa la 
membrana}
...
una proteina transmembrana a singolo passaggio si inserisce nella membrana ER. In un caso una sequenza di segnale \ce{N} terminale inizia la traslocazione, ma un segmento idrofobico
...
lume ER. In un caso la proteina di membrana ha la terminazione \ce{C} sul lato del lume, mentre nell'altro ha la terminazione \ce{N} sul lato del lume. L'orientamento dipende dalla
distribuzione di amminoacidi carichi vicini.
\subsection{Combinazioni di segnali di inizio e terminazione del trasferimento determinano la topologia delle proteine di membrana multipassaggio}
...
risulta dall'orine relativo nella catena. L'SRP inizia la scansione di una catena non piegata per segmenti idrofobici dalla terminazione \ce{N}, riconoscendo il primo segmento 
...
inserimento.
\subsection{Proteine ancorate a ER con la coda sono integrate nella membrana ER con un meccanismo speciale}
Molte proteine di membrana sono ancorate ad essa da una $\alpha$-elica transmembrana idrofobica \ce{C} terminale. Queste proteine ER ancorate dalla code includono subunit\`a di proteine 
...
mentre la maggior parte della proteina rimane nel citosol. La posizione unica dell'$\alpha$-elica la traduzione termina mentre gli amminoacidi \ce{C} terminali non sono ancora emersi
...
amminoacidi alla loro terminazione \ce{C} responsabile del mantenimento delle proteine nell'ER. Alcune di queste funzionano come catalizzatori dell'ossidazione del gruppo sulfidrile
...
\subsection{La maggior parte delle proteine sintetizzate nell'ER rugoso sono glicolisate dall'addizione di un oligosaccaride comune legato a \ce{N}}
...
precursore \`e trasferito alle proteine alla catena laterale \ce{NH2} di un asparagina nelle proteine \`e collegato \ce{N}. Il trasferimento \`e catalizzato da un complesso enzimatico
...
del lume. La diversit\`a delle strutture degli oligosaccaridi collegati \ce{N} dipende da modificazioni successive. Quando si trova nell'ER tre glucosi e un mannosio sono rimossi
...
Lo studio di calnexina e calreticolina, proteine accompagnatrici nell'ER che richiedono \ce{Ca^{2+}} per la loro attivit\`a ha permesso di determinare il ruolo della glicolizzazione 
...
disulfidi. Calnexina e calreticolina riconoscono oligosaccaridi legati \ce{N} che contengono un singolo glucosio terminale e legano proteine solo dopo che due dei tre glucosi nel 
...
\subsection{Proteine piegate non correttamente sono esportate dall'ER e degradate nel citosol}
...
degradazione avviene grazie agli oligosaccaridi legati \ce{N}, che funzionano come timer per la presenza di una proteina nell'ER. La rimozione di un mannosio da una mannossidasi crea
...
all'idrolisi dell'ATP un ATPasi esomerica della famiglia delle AAA-ATPasi tira la proteina attraverso il traslocatore nel citosl e una \ce{N}-glicanasi rimuove il suo oligosaccaride. 
\subsection{Proteine malpiegate nell'ER attivano una risposta di proteine non piegate}
...
Un processo catalizzato da enzimi dell'ER attacca covalentemente un'ancora glicosilfosfatidilinositolo (GPI) alla terminazione \ce{C} di alcune proteine di membrana destinate per la 
...
\subsection{L'ER assembla la maggior parte dei bistrati lipidici}

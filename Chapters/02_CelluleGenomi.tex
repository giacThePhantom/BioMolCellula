...
\subsection{Tutte le cellule trascrivono porzioni della loro informazione ereditaria nella stessa forma intermedia (RNA)}
...
\subsection{Alcune cellule fissano azoto e anidride carbonica per altre}
...
chimica facilmente incorporata in molecole biologiche. Una gran quantit\`a di energia \`e necessaria per guidare le reazioni che usano le molecole inorganiche di \ce{N2} e \ce{CO2} per 
...
\subsection{I genomi eucarioti sono grandi}

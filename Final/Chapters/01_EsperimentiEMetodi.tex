	...
	\item In base alla luce che utilizzano:
		\begin{itemize}
			...
			\item A fluorescenza: si compone di:
				...
				micromanipolatori in quanto sopra \`e libero. Vengono utilizzate molecole particolari fluorescenti come GFP , TFP e CFP (green, yellow e cyan fluorescent 
...
\begin{itemize}
	...
	\item TEMP, transmission electron microscopy: gli elettroni che costituiscono il fascio attraversano una sezione dove \`e stato creato il vuoto per poi passare completamente
...
forografica che mette in evidenza dove la sonda ha legato il DNA genomico. 
\subsubsection{Western blot}
Assolutamente analogo al Southernn blot ma viene utilizzato per visualizzare le proteine e il passaggio dal gel alla membrana di nitrocellulosa avviene grazie a una corrente elettrica e 
...
\subsubsection{Elettroporazione}
...
\subsubsection{Micro - precipitati}
...
\section{Caratteristiche delle cellule}
